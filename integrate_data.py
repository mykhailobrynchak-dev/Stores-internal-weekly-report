...
# ======== EMPLOYEE GROUPS ========
EMPLOYEE_GROUPS = {
    "Mykhailo": ["LOKO", "KOPIYKA", "HOP HEY", "BEER MARKET", "CAFE RYNOK", "TAISTRA", "BEERLAND K", "WINETIME", "BRSM", "SPAR", "AUCHAN", "OKKO MARKET"],
    "Viktor": ["VARUS", "RUKAVYCHKA", "REMESLO BREWERY", "PYVNA BORODA", "ANRI-PHARM", "ROST"],
    "Khrystyna": ["TOCHKA", "LEPRUKON", "MAXBEER", "SPRAGA", "DIMPYVA", "ALTBIER", "FLOWER SHOP", "NO TABOO", "RODYNNA KOVBASKA", "VAPERY | VAPE SHOP", "VAPORS", "PIVASOV", "MEALTIME", "CHILL TIME", "MILLION FLOWERS"],
    "NEW w/o AM": ["ATB", "FLOWERS UA", "THRASH", "E-ZOO", "MASTER ZOO", "BYLE TA SYKHE", "FORA", "ANC", "BLYZENKO", "LIKI 24"],
}
