...
ALL_TRACKED_PARTNERS = [
    ...
    "BRSM", "VAPORS", "VAPE SHOP KYIV", "PIVASOV", "OKKO MARKET", "VAPERY | VAPE SHOP"
]
...
# ======== EMPLOYEE GROUPS ========
EMPLOYEE_GROUPS = {
    "Khrystyna": ["LEPRUKON", "DIMPYVA", "CHILL TIME", "RODYNNA KOVBASKA", "NO TABOO", "VAPORS", "VAPE SHOP KYIV", "PIVASOV", "VAPERY | VAPE SHOP"],
    "Mykhailo": ["LOKO", "HOP HEY", "BEER MARKET", "KOPIYKA", "PYVNA BORODA", "BRSM", "TAISTRA", "CAFE RYNOK", "BEERLAND K", "BEERLAND", "WINETIME", "SPRAGA", "MAXBEER", "SPAR", "OKKO MARKET"],
