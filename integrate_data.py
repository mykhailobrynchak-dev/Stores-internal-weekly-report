...
# ======== EMPLOYEE GROUPS ========
EMPLOYEE_GROUPS = {
    "Mykhailo": ["LOKO", "KOPIYKA", "HOP HEY", "BEER MARKET", "CAFE RYNOK", "TAISTRA", "BEERLAND K", "WINETIME", "BRSM", "SPAR", "OKKO MARKET"],
    ...
    "NEW w/o AM": ["AUCHAN", "ATB", "FLOWERS UA", "THRASH", "E-ZOO", "MASTER ZOO", "BYLE TA SYKHE", "FORA", "ANC", "BLYZENKO", "LIKI 24"],
}
