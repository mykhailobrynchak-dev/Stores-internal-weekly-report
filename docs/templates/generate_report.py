#!/usr/bin/env python3
"""Generate {{PARTNER_DISPLAY}} report (index.html) from Databricks.
...
Ставимо плейсхолдери — агент / користувач замінює:
  {{PARTNER_NAME}}      — точне значення dim_provider_v2.group_name (UPPERCASE як у БД)
  {{PARTNER_DISPLAY}}   — людська назва для логів і JSON
  {{DATA_START}}        — стартова дата monthly даних, формат YYYY-MM-DD
